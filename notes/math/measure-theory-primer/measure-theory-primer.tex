...
\begin{itemize}
  ...
  \end{align}
  and their finite unions. However, we cannot claim that it is a measure because (1) we do not know whether this collection of sets is a $\sigma$-algebra, and (2) we have not defined how to deal with countable unions of such intervals yet.
  ...
  \end{itemize}
  An algebra, however, is not equivalent to a $\sigma$-algebra.
