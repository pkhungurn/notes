...
\begin{itemize}
  ...
  \item Conceptually, the Markov chain simulates movement of a partition. It above keeps the current position $\ve{x}_n$ of the particle in memory. To get to the text positive, it gives the partical a random kick $\ve{p}_n$ and simulate Hamiltonian dynamics to see where the particle lands after time $N\Delta t$.
\end{itemize}
